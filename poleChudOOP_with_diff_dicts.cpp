...
public:
    ...
    void setDict(int number = 1)
    {
        if (number == 1)
        {
            dict = { "Kurdistan", "Anarchy", "communism", "exploitation", "expropriation",
        ...
        {
            dict = { "cat", "dog", "dragon", "firefly", "zebra", "capibara",
            "manul", "wombat", "chicken", "cow", "emu", "tiger", "bear", "grizzly",
            "vyvern", "squirrel", "hedgehog", "elephant", "rhino", "rat" };
        }
        else if (...)
        {
        }
